...
/****** Object:  StoredProcedure [bdp_rpt].[sp_GVOverview_v2]    Script Date: 9/22/2026 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [bdp_rpt].[sp_GVOverview_v2]
	@UserId INT = NULL
...
BEGIN
	...
	BEGIN
		DECLARE @DebugOutput NVARCHAR(MAX) =
			'Debug Info - sp_GVOverview_v2' + CHAR(13) + CHAR(10) +
...
-- EXEC sp_helptext '[bdp_rpt].[sp_GVOverview_v2]';
-- GO
